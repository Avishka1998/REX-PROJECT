...
<div class="column" style="width: 70%;">
       <div class="row">
                <center><h1>Add Your Instruments</h1></center>
                        ...
                        if($rows>=1){
                                ...
                                <div class="row">
                                        ...
                                        <div class="column" style="padding: 15px 500px;">
                                                <button type="submit_name" class="btn" name="submit_instrument2">Save</button>
                                        </div>
                                ...
                                if($result_set2){
                                                ...
                                                echo '<div class="row" >                               
                                                        ...
                                                        <div class="column" >
                                                                <div class="form-popup" id="dvservice'.$record['id'].'" >  
                                                                        ...
                                                                        <label for="name" class="form__label">charge per hour</label>
                                                                        <input type="text" class="form__input"  name="qty'.$record['id'].'" placeholder="Number of instruments" />
                                                                        <label for="name" class="form__label">Number of instruments</label>
                                                                        </div>                               
                                        ...
                                        <div class="row">
                                                <div class="column" style="padding: 10px 500px;">
                                                        <button type="submit_name" class="btn" name="submit_instrument1">Save</button>
                                                </div>
...
<div class="column" style="width: 30%;">
        <div class="row">
                ...
                <?php   
                        $query="SELECT * FROM studio_instrument WHERE studio_id=$user_id";
                        ...
                        if($result_set){
                                ...
                                //      $errors[]="There is no services from customers";
                                    ...
                                    $table = "<table>";                                    
                                    $table .= "<tr><th>Instrument</th><th>Charge(Rs) per day</th><th>Number of Instruments";
