            ...
            if(!strlen(trim($_POST['search']))>0){
                ...
                if($result_set){
                    ...
                    if($no_results>=1){
                        ...
                        header('Location: ../../view/customer/cust_complaint.php?search_result='.urlencode(serialize($record))); //send the array with an url
                    }else{
                        //$error="not found";
                        header('Location: ../../view/customer/cust_complaint.php?error= sorry! studio not found');
                    }
